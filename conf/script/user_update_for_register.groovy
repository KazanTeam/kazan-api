...
String result = Main.utility.qry("update users set email=?,first_name=?,last_name=?,user_name=?,password=? where user_id=?", 
                [email,first_name,last_name,user_name,password,user_id], "default");
